    ...
    <section className="py-16 md:py-32 bg-bg-primary">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center">
          <div>
            <h2 className="font-heading font-bold text-3xl md:text-4xl tracking-tight text-[#111111] mb-6 md:mb-8">
            ...
            <p className="font-body font-normal text-base leading-relaxed text-[#555555] mb-10 md:mb-12">
            ...
            <div className="grid grid-cols-3 gap-4 md:gap-8 border-t border-gray-100 pt-8 md:pt-10">
              <div>
                ...
                <p className="font-body font-medium text-sm text-[#333333] mt-1">Properties</p>
              </div>
              <div>
                <p className="font-heading font-bold text-3xl md:text-4xl text-text-primary">100%</p>
                <p className="font-body font-medium text-sm text-[#333333] mt-1">Satisfaction</p>
              </div>
              <div>
                <p className="font-heading font-bold text-3xl md:text-4xl text-text-primary">2.4K+</p>
                <p className="font-body font-medium text-sm text-[#333333] mt-1">Clients</p>
              </div>
            </div>
          </div>
