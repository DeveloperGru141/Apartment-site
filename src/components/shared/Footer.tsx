...
const propertyTypes = [
  { label: "Apartment Rentals", type: "apartment" },
  { label: "Duplexes", type: "duplex" },
...
const neighborhoods = [
  { label: "Ikoyi", city: "ikoyi" },
  { label: "Victoria Island", city: "victoria-island" },
  { label: "Lekki", city: "lekki" },
  { label: "Banana Island", city: "banana-island" },
  { label: "Oniru", city: "oniru" },
  { label: "Parkview", city: "parkview" },
];
        ...
        <div className="grid gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 rounded-lg bg-amber-500 px-4 py-2.5 text-sm font-semibold text-slate-950 transition-colors hover:bg-amber-600"
            >
        ...
        <div className="mt-12 border-t border-gray-700 pt-8">
          <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
            ...
            <div className="flex gap-6">
              <Link href="/legal/privacy" className="text-sm text-gray-400 transition-colors hover:text-white">
                Privacy Policy
              </Link>
              <Link href="/legal/terms" className="text-sm text-gray-400 transition-colors hover:text-white">
                Terms
              </Link>
              <Link href="/legal/cookies" className="text-sm text-gray-400 transition-colors hover:text-white">
                Cookies
              </Link>
              <Link href="/legal/disclaimer" className="text-sm text-gray-400 transition-colors hover:text-white">
                Disclaimer
              </Link>
            </div>
          </div>
