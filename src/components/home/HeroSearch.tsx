...
export default function HeroSearch() {
  ...
  function handleSearch() {
    const link = getWhatsAppInquiryLink({
      title: `General Search Inquiry (${activeTab.replace("_", " ")})`,
      location: selectedNeighborhood || "All Lagos Prime Locations",
    })
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            <button
              ...
              className="bg-amber-500 hover:bg-amber-600 text-slate-950 font-bold text-xs uppercase tracking-wider py-3.5 px-6 flex items-center justify-center gap-2 transition-all shadow-lg hover:shadow-amber-500/20"
            >
